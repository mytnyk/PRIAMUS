...
**********************/
   ...
   */
     ...
     private ifCustomFormat customLabelFormat = null;
...
//      System.out.println("label_exponent"+label_exponent);
        ...
        for(i=0; i<label_count; i++) {
            ...
            if (customLabelFormat == null)
                ...
                label_string[i] = customLabelFormat.formatDouble(val);
...
******************/
   ...
   */
      ...
      public void setCustomLabelFormat(ifCustomFormat customLabelFormat) {
