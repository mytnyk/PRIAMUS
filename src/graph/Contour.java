...
*/
	 static final int MINCELLS = 10;//30
/*
 ...
 */
   ...
   */
     ...
     private ifCustomFormat customFormat = null;
     ...
     private void calcLabels() {
        ...
        for(i=0; i<labels.length; i++) {
             ...
             if (customFormat == null)
                ...
                labels[i].setText(customFormat.formatDouble(levels[i]));
        }
     }
...
*/
    ...
    public void setCustomFormat(ifCustomFormat customFormat) {
